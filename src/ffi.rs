...
#![allow(deref_nullptr)]
type Tcl_FreeProc = *const ::std::os::raw::c_void;

pub const TCL_USE_STUBS: u32 = 1;
...
pub const TCL_VERSION: &[u8; 4usize] = b"8.6\0";
pub const TCL_PATCH_LEVEL: &[u8; 7usize] = b"8.6.12\0";
...
pub const TCL_LL_MODIFIER: &[u8; 3usize] = b"ll\0";
